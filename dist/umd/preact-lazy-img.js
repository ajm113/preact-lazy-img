...
if(e.prototype&&e.prototype.render?(o=new e(t,n),L.call(o,t,n)):(o=new L(t,n),o.constructor=e,o.render=j),r)for(var i=r.length;i--;)if(r[i].constructor===e){o.nextBase=r[i].nextBase,r.splice(i,1)
...
if(_&&x!==_&&l!==g){var L=_.parentNode
L&&x!==L&&(L.replaceChild(x,_),S||(_._component=null,w(_,!1)))}if(S&&E(S),e.base=x,x&&!o){for(var z=e,M=e;M=M._parentComponent;)(z=M).base=x
x._component=z,x._componentConstructor=z.constructor}}if(!v||n?V.unshift(e):C||(e.componentDidUpdate&&e.componentDidUpdate(f,d,y),W.afterUpdate&&W.afterUpdate(e)),null!=e._renderCallbacks)for(;e._renderCallbacks.length;)e._renderCallbacks.pop().call(e)
...
return r&&a&&(!o||r._component)?(k(r,c,3,n,o),e=r.base):(i&&!u&&(E(i),e=l=null),r=O(t.nodeName,c,n),e&&!r.nextBase&&(r.nextBase=e,l=null),k(r,c,1,n,o),e=r.base,l&&e!==l&&(l._component=null,w(l,!1))),e}function E(e){W.beforeUnmount&&W.beforeUnmount(e)
var t=e.base
e._disable=!0,e.componentWillUnmount&&e.componentWillUnmount(),e.base=null
var n=e._component
n?E(n):t&&(t.__preactattr_&&t.__preactattr_.ref&&t.__preactattr_.ref(null),e.nextBase=t,d(t),x(e),C(t)),e.__ref&&e.__ref(null)}function L(e,t){this._dirty=!0,this.context=t,this.props=e,this.state=this.state||{}}function z(e,t,n){return h(n,e,{},!1,t,!1)}Object.defineProperty(t,"__esModule",{value:!0})
...
var $={h:r,createElement:r,cloneElement:l,Component:L,render:z,rerender:a,options:W}
t.default=$,t.h=r,t.createElement=r,t.cloneElement=l,t.Component=L,t.render=z,t.rerender=a,t.options=W},function(e,t,n){"use strict"
...
return n=i=r(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),i.update=function(e){i.props.onWindowScroll&&(0,s.debounce)(i.props.onWindowScroll,50)(e),i.props.onWindowResize&&(0,s.debounce)(i.props.onWindowResize,50)(e)},l=n,r(i,l)}return i(t,e),a(t,[{key:"render",value:function(e){var t=u(e.children,1),n=t[0]
