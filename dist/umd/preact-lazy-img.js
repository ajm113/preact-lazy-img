...
o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),a=n(1),f=n(3),s={passive:!0},p=function(e){function t(){var e,n,i,u
o(this,t)
for(var c=arguments.length,l=Array(c),a=0;a<c;a++)l[a]=arguments[a]
return n=i=r(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(l))),i.windowResizeEvent=function(e){if(i.props.onWindowResize)return(0,f.debounce)(i.props.onWindowResize,100)(e)},i.windowScrollEvent=function(e){if(i.props.onWindowScroll)return(0,f.debounce)(i.props.onWindowScroll,100)(e)},u=n,r(i,u)}return i(t,e),l(t,[{key:"render",value:function(e){var t=c(e.children,1),n=t[0]
...
var r=n(0),i=o(r),u=n(4),c=o(u),l=n(!function(){var e=new Error('Cannot find module "./components/LazyImgGroup"')
throw e.code="MODULE_NOT_FOUND",e}()),a=o(l)
t.LazyImgWrapper=i.default,t.LazyImg=c.default,t.LazyImgGroup=a.default},function(e,t,n){"use strict"
function o(e,t){var n=this,o=arguments,r=arguments.length>2&&void 0!==arguments[2]&&arguments[2],i=0
return function(){var u=n,c=o,l=function(){i=0,r||e.apply(u,c)},a=r&&!i
clearTimeout(i),i=setTimeout(l,t),a&&e.apply(u,c)}}Object.defineProperty(t,"__esModule",{value:!0}),t.debounce=o},function(e,t,n){"use strict"
...
for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o])}return e},a=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n]
o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),f=n(1),s=n(0),p=function(e){return e&&e.__esModule?e:{default:e}}(s),d=function(e){function t(e){r(this,t)
var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
return n.onScrollOrResize=function(e){n.setState({visible:n.isInViewport()})},n.state={visible:!1},n.el=null,n}return u(t,e),a(t,[{key:"render",value:function(e,t){var n=this,r=t.visible,i=o(e,[]),u=i.placeholder?i.placeholder:(0,f.h)("div",{ref:function(e){return n.el=e},style:{height:i.height},className:"lazyload-placeholder"})
return(0,f.h)(p.default,{onWindowScroll:this.onScrollOrResize,onWindowResize:this.onScrollOrResize},r?(0,f.h)("img",l({},i,{ref:function(e){return n.el=e}})):"function"===u?u():u)}},{key:"componentDidMount",value:function(){this.setState({visible:this.isInViewport()})}},{key:"isInViewport",value:function(){if(!this.el)return!1
var e=this.el.getBoundingClientRect().top
return this.el.getBoundingClientRect().bottom+this.props.cushion>=0&&e-this.props.cushion<=window.innerHeight}}]),t}(f.Component)
